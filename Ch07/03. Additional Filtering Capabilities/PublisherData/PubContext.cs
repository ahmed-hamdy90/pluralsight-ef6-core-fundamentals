...
public class PubContext: DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        // optionsBuilder
        //     .UseSqlServer(sqlConnectionString) // First Add connection string
        //     .LogTo(Console.WriteLine); // Define Logging SQL logs to Target, Here use Console.WriteLine as Delegate

        /* We can Filter the Logs line through Pass Class Names as string **/
        // optionsBuilder
        //     .UseSqlServer(sqlConnectionString)
        //     .LogTo(Console.WriteLine, new[] { DbLoggerCategory.Database.Command.Name }); // Includes Command Execution Only
        
        /* We can Filter the Logs line through Pass Class Names as string Plus Define Logs Level Too **/
        // optionsBuilder
        //     .UseSqlServer(sqlConnectionString)
        //     .LogTo(
        //         Console.WriteLine,
        //         new[] { DbLoggerCategory.Database.Command.Name },
        //         LogLevel.Information); // Includes Command Execution Only Plus Information Log Level

        /* We Need to Display Sensitive Data within Log's Output **/
        optionsBuilder
            .UseSqlServer(sqlConnectionString)
            .LogTo(
                Console.WriteLine,
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Example of mapping UnConventional FK
        // modelBuilder.Entity<Author>()
        //             .HasMany(author => author.Books)
        //             .WithOne(book => book.Author)
        //             .HasForeignKey(book => book.AuthorFK);

        // Option #2: To Enable of Adding Book without Author
        // modelBuilder.Entity<Author>()
        //     .HasMany(author => author.Books)
        //     .WithOne(book => book.Author)
