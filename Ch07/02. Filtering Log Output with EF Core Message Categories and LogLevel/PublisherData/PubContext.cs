...
public class PubContext: DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        /* Now We can Filter the Logs line through Pass Class Names as string **/
        // optionsBuilder
        //     .UseSqlServer(sqlConnectionString)
        //     .LogTo(Console.WriteLine, new[] { DbLoggerCategory.Database.Command.Name }); // Includes Command Execution Only
        
        /* Now We can Filter the Logs line through Pass Class Names as string Plus Define Logs Level Too **/
        optionsBuilder
            .UseSqlServer(sqlConnectionString)
            .LogTo(
                Console.WriteLine,
